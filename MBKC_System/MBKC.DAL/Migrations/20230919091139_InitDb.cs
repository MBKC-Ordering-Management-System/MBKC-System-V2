    ...
    public partial class InitDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandAccount", x => new { x.BrandId, x.AccountId });
                    table.ForeignKey(
                        name: "FK_BrandAccount_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BrandAccount_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "BrandId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    Logo = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483647, nullable: false),
                    ManagerAccount = table.Column<int>(type: "int", nullable: false),
                    WalletId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "KitchenCenterMoneyExchange",
                columns: table => new
                {
                    ExchangeId = table.Column<int>(type: "int", nullable: false),
                    KitchenCenterId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitchenCenterMoneyExchange", x => new { x.ExchangeId, x.KitchenCenterId });
                    table.ForeignKey(
                        name: "FK_KitchenCenterMoneyExchange_KitchenCenters_KitchenCenterId",
                        column: x => x.KitchenCenterId,
                        principalTable: "KitchenCenters",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KitchenCenterMoneyExchange_MoneyExchanges_ExchangeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashierMoneyExchange", x => new { x.ExchangeId, x.CashierId });
                    table.ForeignKey(
                        name: "FK_CashierMoneyExchange_Cashiers_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Cashiers",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashierMoneyExchange_MoneyExchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "MoneyExchanges",
                        principalColumn: "ExchangeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreAccount", x => new { x.StoreId, x.AccountId });
                    table.ForeignKey(
                        name: "FK_StoreAccount_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "AccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StoreAccount_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StoreMoneyExchange", x => new { x.ExchangeId, x.StoreId });
                    table.ForeignKey(
                        name: "FK_StoreMoneyExchange_MoneyExchanges_ExchangeId",
                        column: x => x.ExchangeId,
                        principalTable: "MoneyExchanges",
                        principalColumn: "ExchangeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StoreMoneyExchange_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "StoreId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandAccount_AccountId",
                table: "BrandAccount",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CashierMoneyExchange_AccountId",
                table: "CashierMoneyExchange",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_CashierMoneyExchange_ExchangeId",
                table: "CashierMoneyExchange",
                column: "ExchangeId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitchenCenterMoneyExchange_ExchangeId",
                table: "KitchenCenterMoneyExchange",
                column: "ExchangeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_KitchenCenterMoneyExchange_KitchenCenterId",
                table: "KitchenCenterMoneyExchange",
                column: "KitchenCenterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StoreAccount_AccountId",
                table: "StoreAccount",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StoreMoneyExchange_ExchangeId",
                table: "StoreMoneyExchange",
                column: "ExchangeId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StoreMoneyExchange_StoreId",
                table: "StoreMoneyExchange",
                column: "StoreId");
