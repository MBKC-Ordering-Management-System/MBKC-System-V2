        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandManagerEmail = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScrawlingMoneyExchangeToKitchenCenter = table.Column<TimeSpan>(type: "time", nullable: false),
                    ScrawlingMoneyExchangeToStore = table.Column<TimeSpan>(type: "time", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitchenCenters", x => x.KitchenCenterId);
                    table.ForeignKey(
                        name: "FK_KitchenCenters_Accounts_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "KitchenCenterId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    Logo = table.Column<string>(type: "varchar(max)", unicode: false, maxLength: 2147483647, nullable: false),
                    StoreManagerEmail = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemStatus = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
                    PartnerId = table.Column<int>(type: "int", nullable: false),
                    StoreId = table.Column<int>(type: "int", nullable: false),
                    DisplayId = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
                    Address = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Cutlery = table.Column<int>(type: "int", nullable: true),
                    PartnerOrderStatus = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SystemStatus = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    PartnerOrderStatus = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    KCBankingAccountId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerProducts", x => new { x.ProductId, x.PartnerId, x.StoreId, x.CreatedDate, x.MappedDate });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ScrawlingMoneyExchangeToKitchenCenter", "ScrawlingMoneyExchangeToStore", "ScrawlingOrderEndTime", "ScrawlingOrderStartTime" },
                values: new object[] { 1, new TimeSpan(0, 22, 0, 0, 0), new TimeSpan(0, 23, 0, 0, 0), new TimeSpan(0, 12, 0, 0, 0), new TimeSpan(0, 12, 0, 0, 0) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KitchenCenters_ManagerId",
