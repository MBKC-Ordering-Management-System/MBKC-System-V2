...
namespace MBKC.Service.Services.Interfaces
{
    public interface ICategoryService
    {
        ...
        public Task<GetCategoriesResponse> GetCategoriesAsync(string type, string? keySearchName, int? pageNumber, int? pageSize, HttpContext httpContext, bool? isGetAll);
