...
namespace MBKC.Service.Services.Interfaces
{
    public interface IPartnerProductService
    {
        ...
        public Task<GetPartnerProductsResponse> GetPartnerProductsAsync(string? searchName, string? keySortProductCode, string? keySortStatus, int? currentPage, int? itemsPerPage, IEnumerable<Claim> claims);
